...
Java_com_qualcomm_QCARSamples_FrameMarkers_FrameMarkers_initTracker(JNIEnv * env, jobject)
{
    ...
    while(i<20){
    	...
    	intToStr(suffix, i);
    	LOG("%s",suffix);
    	if(!markerTracker->createFrameMarker(i, suffix, QCAR::Vec2F(50,50))){
